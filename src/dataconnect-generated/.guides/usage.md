...
Here's an example:
```
import { injectCreateUser, injectGetProducts, injectAddToCart, injectGetCart } from '@dataconnect/generated/angular';
...
class MyComponent {
  ...
  private readonly AddToCartOperation = injectAddToCart(addToCartVars);
  private readonly GetCartOperation = injectGetCart();
  }
```
...
```js
import { createUser, getProducts, addToCart, getCart } from '@dataconnect/generated';
